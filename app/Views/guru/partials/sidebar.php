    ...
    <div class="collapse navbar-collapse h-auto  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item  <?= set_active('guru') ?>">
                <a href="<?= base_url('guru') ?>" class="nav-link <?= set_active('') ?>">
            ...
            <li class="nav-item">
                <a href="<?= base_url('guru/jadwalujian') ?>" class="nav-link <?= set_active('jadwalujian') ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                    ...
                    <span class="nav-link-text ms-1">Ujian Saya</span>
                </a>
            </li>
            <li class="nav-item">
                <a href="<?= base_url('guru/hasilujian') ?>" class="nav-link <?= set_active('hasilujian') ?>">
                    <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                            <title>office</title>
                            <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
